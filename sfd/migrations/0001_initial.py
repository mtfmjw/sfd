# Generated by Django 5.2.7 on 2025-12-28 20:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_from', models.DateField(default=sfd.models.base.default_valid_from_date, verbose_name='Valid From')),
                ('valid_to', models.DateField(blank=True, default=sfd.models.base.default_valid_to_date, verbose_name='Valid To')),
                ('family_name', sfd.common.encrypted.EncryptedCharField(db_index=True, max_length=184, original_max_length=64, searchable=True, verbose_name='Family Name')),
                ('family_name_kana', sfd.common.encrypted.EncryptedCharField(db_index=True, max_length=184, original_max_length=64, searchable=True, verbose_name='Family Name Kana')),
                ('family_name_romaji', sfd.common.encrypted.EncryptedCharField(blank=True, db_index=True, max_length=184, null=True, original_max_length=64, searchable=True, verbose_name='Family Name Romaji')),
                ('name', sfd.common.encrypted.EncryptedCharField(db_index=True, max_length=184, original_max_length=64, searchable=True, verbose_name='Name')),
                ('name_kana', sfd.common.encrypted.EncryptedCharField(db_index=True, max_length=184, original_max_length=64, searchable=True, verbose_name='Name Kana')),
                ('name_romaji', sfd.common.encrypted.EncryptedCharField(blank=True, db_index=True, max_length=184, null=True, original_max_length=64, searchable=True, verbose_name='Name Romaji')),
                ('birthday', sfd.common.encrypted.EncryptedDateField(blank=True, max_length=180, null=True, original_max_length=10, verbose_name='Birthday')),
                ...
                ('email', sfd.common.encrypted.EncryptedEmailField(blank=True, db_index=True, max_length=272, null=True, original_max_length=128, searchable=True, verbose_name='Email')),
                ('phone_number', sfd.common.encrypted.EncryptedCharField(blank=True, db_index=True, max_length=144, null=True, original_max_length=20, searchable=True, verbose_name='Phone Number')),
                ('mobile_number', sfd.common.encrypted.EncryptedCharField(blank=True, db_index=True, max_length=144, null=True, original_max_length=20, searchable=True, verbose_name='Mobile Number')),
                ('address_detail', sfd.common.encrypted.EncryptedCharField(blank=True, max_length=448, null=True, original_max_length=256, verbose_name='Address Detail')),
                ('family_name_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Family Name Hash')),
                ('family_name_kana_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Family Name Kana Hash')),
                ('family_name_romaji_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Family Name Romaji Hash')),
                ('name_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Name Hash')),
                ('name_kana_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Name Kana Hash')),
                ('name_romaji_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Name Romaji Hash')),
                ('email_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Email Hash')),
                ('phone_number_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Phone Number Hash')),
                ('mobile_number_hash', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='Mobile Number Hash')),
            ...
            options={
                ...
                'permissions': [('view_personal_info', 'Can view personal information'), ('change_personal_info', 'Can edit personal information')],
            },
        ),
        migrations.CreateModel(
            name='UserUpload',
