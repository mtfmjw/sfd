    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_from', models.DateField(default=sfd.models.base.default_valid_from_date, verbose_name='Valid From')),
                ('valid_to', models.DateField(blank=True, default=sfd.models.base.default_valid_to_date, verbose_name='Valid To')),
                ('family_name', sfd.common.encrypted.EncryptedCharField(max_length=180, original_max_length=100, verbose_name='Family Name')),
                ('family_name_kana', sfd.common.encrypted.EncryptedCharField(max_length=180, original_max_length=100, verbose_name='Family Name Kana')),
                ('family_name_romaji', sfd.common.encrypted.EncryptedCharField(blank=True, max_length=180, null=True, original_max_length=100, verbose_name='Family Name Romaji')),
                ('name', sfd.common.encrypted.EncryptedCharField(max_length=180, original_max_length=100, verbose_name='Name')),
                ('name_kana', sfd.common.encrypted.EncryptedCharField(max_length=180, original_max_length=100, verbose_name='Name Kana')),
                ('name_romaji', sfd.common.encrypted.EncryptedCharField(blank=True, max_length=180, null=True, original_max_length=100, verbose_name='Name Romaji')),
                ('birthday', sfd.common.encrypted.EncryptedDateField(blank=True, null=True, verbose_name='Birthday')),
                ...
                ('email', sfd.common.encrypted.EncryptedEmailField(blank=True, max_length=385, null=True, original_max_length=100, verbose_name='Email')),
                ('phone_number', sfd.common.encrypted.EncryptedCharField(blank=True, max_length=70, null=True, original_max_length=20, verbose_name='Phone Number')),
                ('mobile_number', sfd.common.encrypted.EncryptedCharField(blank=True, max_length=70, null=True, original_max_length=20, verbose_name='Mobile Number')),
                ('address_detail', sfd.common.encrypted.EncryptedCharField(blank=True, max_length=400, null=True, original_max_length=255, verbose_name='Address Detail')),
